...
#define STREAM_REGISTRY "audio_stream_registry"
...
/* Session-pool storage; the mutex protects membership and list readers against CLOSE. */
typedef struct {
    switch_mutex_t *mutex;
    struct private_data *head;
} stream_registry_t;
...
struct private_data {
    ...
    struct private_data *next_stream;
